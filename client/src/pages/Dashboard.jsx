  ...
  return (
    <div className="dashboard-container">
      ...
      <p className="welcome-message">
        Welcome, {username || 'User'}! You are logged in as a {role || 'user'}.
      </p>

      {/* Todo Section */}
      <h2 className="section-heading-todo">Your Todos</h2>
      ...
      {role === 'admin' ? (
        <div className="admin-panel">
          <h2 className="section-heading-admin">Admin Panel - User Management</h2>
        ...
        <p className="user-message">
          This is the normal user dashboard. Enjoy your stay!
        </p>
      )}
